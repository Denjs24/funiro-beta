...
window.onload = function (){
    ...
    function documentActions(e) {
        ...
        if (targetElement.classList.contains('cart-header__icon') || targetElement.closest('.cart-header__icon')) {
            ...
            e.preventDefault();
        }else if(!targetElement.closest('.cart-header') && !targetElement.classList.contains('.actions-products__button')){
    ...
    function updateCart(productButton, productId, productAdd = true) {
        ...
        const cartQuantuty = cartIcon.querySelector('span');
        ...
        if (productAdd) {
            if (cartQuantuty) {
                cartQuantuty.innerHTML= ++cartQuantuty.innerHTML;
            }else{
            ...
            if (!cartProduct) {
                ...
                <div class="cart-list__body">
                    ...
                    <div class="cart-list__quantity">Quantuty: <span>1</span></div>
            ...
            const cartQuantutyValue = --cartQuantuty.innerHTML;

            if (cartQuantityValue) {
                cartQuantuty.innerHTML = cartQuantutyValue;
            }else{
                cartQuantuty.remove();
